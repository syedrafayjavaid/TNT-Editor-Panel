...
const Profile = () => {
    ...
    const handleChange = (e, func, errorFunc) => {
     ...
     function EditProfile () {
      ...
      /// fecthing editor data

    const adminData = async ()=>{

        var username = localStorage.getItem("userName");
   
    await axios.get(config.base_url+"/editor/getdetail/"+username)
    .then(res=>{
    ...
    await axios.post(config.base_url+'/editor/updateprofile',data)
    .then(res=>{
   ...
   await axios.post(config.base_url+"/editor/login",adminData)
    ...
    return (
        ...
        <Card ClassName="card text-center" style={{width:"700px",marginLeft:"310px"}}>
              <Card.Header  className="productsgallerybar" style={{backgroundColor:"#C0392B"}}>
                <Card.Title  style={{marginBottom:"14px", textAlign:"center" ,fontSize:"25px",fontFamily:"Baufra",color:"white"}}  > EDITOR PROFILE   </Card.Title>
        ...
        {change===true?
        <Button variant="contained" style={{backgroundColor:"#C0392B"}} size ="large"onClick={handleClickOpen} fullWidth>Save Changes</Button>
        :
        <Button variant="contained" style={{backgroundColor:"#C0392B",color:"white"}} size ="large"onClick={EditProfile} fullWidth>Edit Profile</Button>
        }
        </Col>
        <Col></Col>
        </Row>
        ...
        <Dialog maxWidth={"xs"} fullWidth
                ...
                >
                <DialogTitle className="dialogHeading" id="alert-dialog-title">CONFIRMATION</DialogTitle>
                ...
                <DialogActions style={{backgroundColor:""}}>
                 <Grid container justify="center" style={{textAlign:"center"}}>
                    <Grid item xs={6}>
                      <Button  onClick={handleClose} style={{color:"#C0392B"}}>
                        Cancel
                      </Button>
                    </Grid>
                    <Grid item xs={6}>
                        <Button  type="submit" onClick={handleClickOpen2} style={{ color:"#C0392B"}}>
                            Submit
                        </Button>
